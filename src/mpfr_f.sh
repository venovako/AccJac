...
do
    ...
    echo "    INTEGER(KIND=MPFR_RND_KIND), INTENT(IN) :: RND"
    ...
    echo "    IF (INFO .EQ. 0_c_int) INFO = MPFR_${I}(C_LOC(ROP), C_LOC(OP), RND)"
...
do
    ...
    echo "    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int"
    echo "    IF (INFO .EQ. 0_c_int) INFO = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)"
    echo "    IF (PRESENT(I)) I = INT(INFO)"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
...
do
    ...
    echo "    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int"
    echo "    IF (INFO .EQ. 0_c_int) INFO = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), OP2, RND)"
    echo "    IF (PRESENT(I)) I = INT(INFO)"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
...
do
    ...
    echo "    IF (OP2%TAG .EQ. TAG_NULL) INFO = -4_c_int"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int"
    echo "    IF (INFO .EQ. 0_c_int) INFO = MPFR_${I}(C_LOC(ROP), OP1, C_LOC(OP2), RND)"
    echo "    IF (PRESENT(I)) I = INT(INFO)"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
...
do
    ...
    echo "    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int"
    echo "    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int"
    echo "    IF (INFO .EQ. 0_c_int) INFO = MPFR_${I}(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), RND)"
    echo "    IF (PRESENT(I)) I = INT(INFO)"
    echo "  END SUBROUTINE MPFR_${I}_F"
done
unset I
