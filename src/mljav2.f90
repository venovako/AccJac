SUBROUTINE MLJAV2(A11, A22, A21, CH, SH, INFO)
  ...
  CALL MPFR_INIT_F(AA, A21%MPFR_PREC)
  A21P = MAX(CH%MPFR_PREC, SH%MPFR_PREC)
  CALL MPFR_INIT_F(T2, A21P)
  CALL MPFR_INIT_F(T1, A21P)
  CH = ONE
  CALL MPFR_SET_ZERO(SH, 0_c_int)
  ...
  IF (A21P .GT. 0_MPFR_PREC_KIND) CALL MPFR_SET_F(SH, T1)
  CALL MPFR_CLEAR_F(T1)
  CALL MPFR_CLEAR_F(T2)
  CALL MPFR_CLEAR_F(AA)
