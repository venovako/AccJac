...
SUBROUTINE STRANS(M, N, G, LDG, V, LDV, SV, GX, GS, P, Q, TOL, INFO)
  ...
  IF (J .EQ. 0) THEN
     ...
     J = I
     CALL SROTT(M, G(1,P), G(1,Q), C, S, T, SV(P), SV(Q), J)
     IF (J .EQ. 0) CALL SRTVT(N, V(1,P), V(1,Q), C, S, I)
     I = J
  ELSE ! hyp
     CALL SLJV2(APP, AQQ, AQP, C, S, I)
     J = I
     CALL SROTH(M, G(1,P), G(1,Q), C, S, T, SV(P), SV(Q), J)
     IF (J .EQ. 0) CALL SRTVH(N, V(1,P), V(1,Q), C, S, I)
     I = J
  END IF
  IF (I .NE. 0) THEN
     IF (I .LT. 0) THEN
