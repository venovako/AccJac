...
#include "cr.f90"
  ...
  DO WHILE (D .LT. U)
     ...
     I = I + 1
  END DO
  CALL MPFR_CLEAR_F(MG)
  CALL MPFR_CLEAR_F(MF)
  CALL MPFR_CLEAR_F(ME)
  CALL MPFR_CLEAR_F(MS)
  CALL MPFR_CLEAR_F(MC)
  CALL MPFR_CLEAR_F(MT)
  CALL MPFR_CLEAR_F(MD)
  CALL MPFR_CLEAR_F(MO)
  CALL MPFR_FINALIZE()
