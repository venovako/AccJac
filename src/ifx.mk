...
FCFLAGS += -xHost -qopenmp -fPIC -fexceptions -fno-omit-frame-pointer -fp-model precise -fprotect-parens -fma -no-ftz -standard-semantics -traceback -vec-threshold0 -rdynamic -static-libgcc
ifdef NDEBUG
