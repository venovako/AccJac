...
CONTAINS
  ...
  ! MUST be called at before all other subroutines from this module.
  ...
  PURE SUBROUTINE MPFR_INIT_M(LHS, P)
    ...
    INTEGER(KIND=MPFR_PREC_KIND), INTENT(IN), OPTIONAL :: P
    IF (LHS%TAG .NE. TAG_NULL) CALL MPFR_CLEAR(LHS)
    IF (PRESENT(P)) THEN
  ...
  PURE SUBROUTINE MPFR_CBRT_F(ROP, OP, RND, I)
    ...
    IF (OP%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_CBRT(C_LOC(ROP), C_LOC(OP), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_NEG_F(ROP, OP, RND, I)
    ...
    IF (OP%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_NEG(C_LOC(ROP), C_LOC(OP), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_REC_SQRT_F(ROP, OP, RND, I)
    ...
    IF (OP%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_REC_SQRT(C_LOC(ROP), C_LOC(OP), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SQR_F(ROP, OP, RND, I)
    ...
    IF (OP%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SQR(C_LOC(ROP), C_LOC(OP), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SQRT_F(ROP, OP, RND, I)
    ...
    IF (OP%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SQRT(C_LOC(ROP), C_LOC(OP), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_ADD_F(ROP, OP1, OP2, RND, I)
    ...
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_ADD(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_DIV_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_DIV(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_HYPOT_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_HYPOT(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_MUL_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_MUL(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SUB_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SUB(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_ADD_SI_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_ADD_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_DIV_SI_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_DIV_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_MUL_SI_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_MUL_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SUB_SI_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SUB_SI(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SI_DIV_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP2%TAG .EQ. TAG_NULL) INFO = -4_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SI_DIV(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SI_SUB_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP2%TAG .EQ. TAG_NULL) INFO = -4_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SI_SUB(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_ADD_D_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_ADD_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_DIV_D_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_DIV_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_MUL_D_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_MUL_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_SUB_D_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_SUB_D(C_LOC(ROP), C_LOC(OP1), OP2, RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_D_DIV_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP2%TAG .EQ. TAG_NULL) INFO = -4_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_D_DIV(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_D_SUB_F(ROP, OP1, OP2, RND, I)
    ...
    IF (OP2%TAG .EQ. TAG_NULL) INFO = -4_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_D_SUB(C_LOC(ROP), OP1, C_LOC(OP2), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_FMA_F(ROP, OP1, OP2, OP3, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_FMA(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), RND)
    IF (PRESENT(I)) I = INT(INFO)
  ...
  PURE SUBROUTINE MPFR_FMS_F(ROP, OP1, OP2, OP3, RND, I)
    ...
    IF (OP1%TAG .EQ. TAG_NULL) INFO = -3_c_int
    IF (ROP%TAG .EQ. TAG_NULL) INFO = -2_c_int
    IF (INFO .EQ. 0_c_int) INFO = MPFR_FMS(C_LOC(ROP), C_LOC(OP1), C_LOC(OP2), C_LOC(OP3), RND)
    IF (PRESENT(I)) I = INT(INFO)
