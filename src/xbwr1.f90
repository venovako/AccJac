!>@brief \b XBWR1 writes a one-dimensional quadruple/extended precision real array to a binary file.
!!
!!@param U [IN]; a connected unit.
!!@param M [IN]; the length of G.
!!@param G [IN]; a quadruple/extended precision real array to be written.
