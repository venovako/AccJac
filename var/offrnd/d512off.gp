...
plot "d512ME.csv" using 1:3 with points title "Mantharam--Eberlein" pointtype 7 linetype 3 pointsize 0.6875, \
     "d512rc.csv" using 1:3 with points title "row-cyclic" pointtype 7 linetype 7 pointsize 0.6875, \
     "d512dR.csv" using 1:3 with points title "modified de\\,Rijk" pointtype 7 linetype -1 pointsize 0.6875
