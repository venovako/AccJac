...
plot "z512rc.csv" using 1:3 with points title "row-cyclic" pointtype 7 linetype 1, \
     "z512dR.csv" using 1:3 with points title "modified de\\,Rijk" pointtype 7 linetype -1
